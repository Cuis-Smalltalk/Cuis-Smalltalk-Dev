...
cd ..
# Tools
git clone https://github.com/Cuis-Smalltalk/Cuis-Smalltalk-Tools.git
# Features intended to be used by applications
...
git clone https://github.com/Cuis-Smalltalk/DatabaseSupport.git
