...
!RectangleLikeMorph methodsFor: 'geometry' stamp: 'jmv 8/21/2012 21:52'!
morphExtent
...
!BorderedRectMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:54'!
drawOn: aCanvas
	aCanvas
...
!BorderedRectMorph methodsFor: 'testing' stamp: 'jmv 8/21/2012 21:54'!
isOpaqueMorph
...
!EllipseMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:55'!
drawOn: aCanvas 
...
!FillInTheBlankMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:56'!
drawOn: aCanvas
	| roundCorners |
...
!HaloHandleMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:57'!
drawOn: aCanvas
...
!HaloMorph methodsFor: 'stepping' stamp: 'jmv 8/21/2012 21:54'!
step
	| newBounds |
	target
		ifNil: [^ self].
...
!HaloMorph methodsFor: 'updating' stamp: 'jmv 8/21/2012 21:54'!
redrawNeeded
...
!ImageMorph methodsFor: 'accessing' stamp: 'jmv 8/21/2012 21:53'!
borderWidth: bw
...
!InnerTextMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:56'!
drawOn: aCanvas
...
!InnerTextMorph methodsFor: 'geometry' stamp: 'jmv 8/21/2012 21:53'!
morphExtent: aPoint
	| newExtent |
...
!InnerTextMorph methodsFor: 'private' stamp: 'jmv 8/21/2012 21:53'!
fit
...
!LayoutAdjustingMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:56'!
drawOn: aCanvas
	aCanvas fillRectangle: self morphBoundsInWorld colorOrInfiniteForm: color borderWidth: 2 borderStyleSymbol: #raised! !

!LayoutAdjustingMorph methodsFor: 'testing' stamp: 'jmv 8/21/2012 21:56'!
isOpaqueMorph
	"Any submorph that answers true to #isOrthoRectangularMorph (to optimize #containsPoint:)
	but is not an opaque rectangle covering bounds MUST answer false to this message"
	color mightBeTranslucent ifTrue: [
...
!MenuMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:57'!
drawOn: aCanvas
...
!MinimalStringMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:56'!
drawOn: aCanvas

	aCanvas drawString: contents in: self morphBoundsInWorld font: self fontToUse color: color! !

!MinimalStringMorph methodsFor: 'accessing' stamp: 'jmv 8/21/2012 21:53'!
fitContents
...
!OneLineEditorMorph methodsFor: 'accessing' stamp: 'jmv 8/21/2012 21:54'!
fitContents
...
!OneLineEditorMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:56'!
drawOn: aCanvas
...
!PasteUpMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:55'!
drawOn: aCanvas
...
!PasteUpMorph methodsFor: 'misc' stamp: 'jmv 8/21/2012 21:52'!
...
!PluggableButtonMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:55'!
...
!PluggableButtonMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:53'!
...
!PluggableButtonMorph methodsFor: 'private' stamp: 'jmv 8/21/2012 21:53'!
magnifiedIcon
	| b |
	magnifiedIcon ifNil: [
...
!ScrollBar methodsFor: 'access' stamp: 'jmv 8/21/2012 21:55'!
color: aColor
...
!ScrollBar methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:55'!
drawOn: aCanvas
...
!ScrollBar methodsFor: 'geometry' stamp: 'jmv 8/21/2012 21:53'!
...
!ScrollBar methodsFor: 'initialize' stamp: 'jmv 8/21/2012 21:55'!
recreateSubmorphs
...
!StringMorph methodsFor: 'accessing' stamp: 'jmv 8/21/2012 21:54'!
fitContents
...
!StringMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:56'!
drawOn: aCanvas
	aCanvas
		drawString: contents
		in: self morphBoundsInWorld
...
!IndentingListItemMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:56'!
drawOn: aCanvas
...
!IndentingListItemMorph methodsFor: 'private' stamp: 'jmv 8/21/2012 21:54'!
toggleRectangle

	^(12*indentLevel @ 0) extent: 12@extent y! !


!MenuItemMorph methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:57'!
drawOn: aCanvas 
...
!SystemWindow methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:55'!
...
!SystemWindow methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:56'!
...
!SystemWindow methodsFor: 'drawing' stamp: 'jmv 8/21/2012 21:53'!
makeMeVisible 
...
!SystemWindow methodsFor: 'geometry' stamp: 'jmv 8/21/2012 21:53'!
morphExtent: aPoint 
...
!SystemWindow methodsFor: 'testing' stamp: 'jmv 8/21/2012 21:55'!
isOpaqueMorph
