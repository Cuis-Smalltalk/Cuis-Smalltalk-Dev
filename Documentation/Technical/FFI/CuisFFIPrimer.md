...
[(Array new: 512) pin] bench '4.89 k runs per second. 204.65 µ seconds per run. 0.06  % GC time  
[(Array new: 1024) pin] bench '4.54 k runs per second. 220.15 µ seconds per run. 0.12  % GC time.' 
