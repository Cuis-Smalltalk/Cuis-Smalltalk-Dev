...
1) Follow HowToBuildMacUnifiedVM.md. Download squeak.cog.spur_linux64ARMv8.tar.gz, squeak.cog.spur_linux64x64.tar.gz, squeak.cog.spur_win64ARMv8.zip, squeak.cog.spur_win64x64.zip.
...
The result is a muiltiplatform CuisVM.app. Its Contents folder is about 32.5Mb
