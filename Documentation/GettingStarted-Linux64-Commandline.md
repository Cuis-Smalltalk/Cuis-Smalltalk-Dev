...
```
~/MyProject# cogspur64/squeak Cuis-Smalltalk-Dev-master/Cuis5.0-3063-spur-64.image
```
...
* If you can't find Cuis5.0-3063-spur-64.image, then this document is outdated. Use the Cuis spur image with the latest update number available.
