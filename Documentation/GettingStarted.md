...
```
cogspur/squeak Cuis-Smalltalk-Dev/Cuis5.0-3511.image
```
...
```
./Squeak.app/Contents/MacOS/Squeak Cuis-Smalltalk-Dev-master/Cuis5.0-3511.image
```
...
### Starting Cuis Smalltalk ###
```
cogspur/Squeak.exe Cuis-Smalltalk-Dev/Cuis5.0-3511.image
```
...
### Starting Cuis Smalltalk ###
```
cogspur/squeak Cuis-Smalltalk-Dev/Cuis5.0-3511-32.image
```
...
```
cogspur/squeak Cuis-Smalltalk-Dev/Cuis5.0-3511-32.image
stkspur/squeak Cuis-Smalltalk-Dev/Cuis5.0-3511-32.image
```
...
* If you can't find Cuis5.0-3511-32.image, then this document is outdated. Use the Cuis spur image with the latest update number available.
