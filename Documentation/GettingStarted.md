...
```
cogspur/squeak Cuis-Smalltalk-Dev/Cuis6.0-5686.image
```
...
### Starting Cuis Smalltalk ###
* drop the Cuis6.0-5686.image over the Squeak.app file
...
### Starting Cuis Smalltalk ###
```
cogspur/Squeak.exe Cuis-Smalltalk-Dev/Cuis6.0-5686.image
```
...
### Starting Cuis Smalltalk ###
```
cogspur/squeak Cuis-Smalltalk-Dev/Cuis6.0-5686-32.image
```
...
```
cogspur/squeak Cuis-Smalltalk-Dev/Cuis6.0-5686-32.image
stkspur/squeak Cuis-Smalltalk-Dev/Cuis6.0-5686-32.image
```
...
* If you can't find Cuis6.0-5686-32.image, then this document is outdated. Use the Cuis spur image with the latest update number available.
