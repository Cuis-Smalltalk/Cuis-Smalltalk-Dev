...
```
~/MyProject# cogspur/squeak Cuis-Smalltalk-Dev/Cuis5.0-3117.image
```
...
```
$ ./Squeak.app/Contents/MacOS/Squeak Cuis-Smalltalk-Dev-master/Cuis5.0-3117.image
```
...
### Starting Cuis Smalltalk ###
```
$ cogspur/squeak.exe Cuis-Smalltalk-Dev/Cuis5.0-3117.image
```
...
### Starting Cuis Smalltalk ###
```
~/MyProject# cogspur/squeak Cuis-Smalltalk-Dev/Cuis5.0-3117-32.image
```
...
```
~/MyProject# cogspur/squeak Cuis-Smalltalk-Dev/Cuis5.0-3117-32.image
~/MyProject# stkspur/squeak Cuis-Smalltalk-Dev/Cuis5.0-3117-32.image
```
...
* If you can't find Cuis5.0-3117-32.image, then this document is outdated. Use the Cuis spur image with the latest update number available.
