...
* extract the contents of the zip file right there ("extract here")
* drop the Cuis6.0-5069-32.image over the Squeak.exe file. Alternatively, double click on the Squeak.exe file, and when prompted to select an image file, select Cuis6.0-5069-32.image.
