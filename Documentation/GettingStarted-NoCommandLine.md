...
* extract the contents of the zip file to your folder
* drop the Cuis5.0-3589-32.image over the Squeak.exe file
...
* drop the Cuis5.0-3589.image over the Squeak.app file
...
* drop the Cuis5.0-3589.image over the Squeak.app file. On subsequent runs, drop the Cuis5.0-3589.image over the Squeak.app file

## Notes ##
* If you can't find Cuis5.0-3589.image, then this document is outdated. Use the Cuis image with the latest update number available.
