...
* extract the contents of the zip file to your folder
* drop the Cuis5.0-3381-32.image over the Squeak.exe file
...
* drop the Cuis5.0-3381.image over the Squeak.app file
...
* drop the Cuis5.0-3381.image over the Squeak.app file. On subsequent runs, drop the Cuis5.0-3381.image over the Squeak.app file

## Notes ##
* If you can't find Cuis5.0-3381-32.image, then this document is outdated. Use the Cuis spur-32 image with the latest update number available.
