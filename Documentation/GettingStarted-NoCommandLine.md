...
* extract the contents of the zip file right there ("extract here")
* drop the Cuis5.0-4810-32.image over the Squeak.exe file. Alternatively, double click on the Squeak.exe file, and when prompted to select an image file, select Cuis5.0-4810-32.image.
...
## Troubleshooting ##
* If you can't find Cuis5.0-4810.image, then this document is outdated. Use the Cuis image with the latest update number available.
