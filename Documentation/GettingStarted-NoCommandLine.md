...
* extract the contents of the zip file to your folder
* drop the Cuis5.0-3224-32.image over the Squeak.exe file
...
* drop the Cuis5.0-3224.image over the Squeak.app file
* [ctrl] click on Cog application. Open. "Cog is from an unidentified developer"; dialog. Click on [Open] Supply required credentials. (This is required only on the first run). Select Cuis5.0-3224.image. (If this step is a problem, you might try the command line variant, described in another document.)
* On subsequent runs, drop the Cuis5.0-3224.image over the Squeak.app file

## Notes ##
* If you can't find Cuis5.0-3224-32.image, then this document is outdated. Use the Cuis spur-32 image with the latest update number available.
