...
* extract the contents of the zip file right there ("extract here")
* drop the Cuis6.0-6053.image over the Squeak.exe file. Alternatively, double click on the Squeak.exe file, and when prompted to select an image file, select Cuis6.0-6053.image.
...
## Troubleshooting ##
* If you can't find Cuis6.0-6053.image, then this document is outdated. Use the Cuis image with the latest update number available.
