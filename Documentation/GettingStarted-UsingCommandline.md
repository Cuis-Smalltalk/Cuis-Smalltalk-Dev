...
### On Linux ###
On Linux we recommend using 64 bits Cuis if possible (i.e. if on x86-64 hardware). See [Setting up and starting Cuis 64 bits using a command line](GettingStarted-UsingCommandline-Linux64.md)
```
$ mkdir MyProject
$ cd MyProject
...
$ tar -zxvf cogspur.tgz
$ mv ./products/cogspurlinuxht ./cogspur
```
